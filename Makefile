...
#    Updated: 2024/09/20 15:37:18 by mokutucu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_DIR = src
SRCS    = src/error.c src/debug_main.c src/init.c src/main.c src/shlvl.c \
		  ...
		  src/3.cmd_parser/populate.c src/3.cmd_parser/strip_command_quotes.c \
		  src/3.cmd_parser/input_redir.c src/3.cmd_parser/process_arg_utils.c \
		  src/3.cmd_parser/heredoc.c src/3.cmd_parser/heredoc_signals.c \
